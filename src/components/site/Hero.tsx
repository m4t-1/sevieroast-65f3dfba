import heroImage from "@/assets/sevie/lounge.jpg";
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
        <div>
          ...
          <h1 className="mt-6 font-serif text-5xl leading-[1.05] text-foreground md:text-6xl lg:text-7xl">
            A quiet corner for great coffee.
          </h1>
          <p className="mt-6 max-w-md text-base leading-relaxed text-muted-foreground md:text-lg">
            Small-batch beans, hand-pulled shots, and warm wood-lined rooms in
            Baesa, QC and Lacson UST, Sampaloc.
          </p>
        ...
        <div className="relative">
          ...
          <img
            src={heroImage}
            alt="Inside Sevie Roast — warm wood interior with lounge seating"
            className="aspect-[4/5] w-full rounded-3xl object-cover shadow-2xl shadow-primary/20"
          />
        </div>
      </div>
    </section>
